      ...
      <v-col> 
        ...
        <v-row>
          ...
          >
            ...
            <div>
              <div v-if="!isShowOxygenVideoPlay && isOutbreak && !isCopeOutbreak" 
              ...
              <div v-else-if="workerHealthValue===0"
                class="d-inline float-left font-weight-thin">
                <v-btn
                  depressed
                  dark
              ...
              <div v-if="workerHealthValue !== 0" 
                class="d-inline float-right font-weight-thin">
                <!--
                <v-btn
                  depressed
                  dark
              ...
              <div v-show="!isShowOxygenVideoPlay">  
                <p v-if="isNormalPlayer === false && workerHealthValue !== 0" 
                ...
                <p v-else-if="isNormalPlayer === true && workerHealthValue !== 0" 
                  class="text-h5 text-center font-weight-light">
                  <v-btn
                    depressed
                    dark
...
export default {
  ...
  computed: {
    ...
    isWorkerEquipment(){
      if( (this.queryWorkAndWorkerEquipment('protect').length +
         this.queryWorkAndWorkerEquipment('safety').length) === 
