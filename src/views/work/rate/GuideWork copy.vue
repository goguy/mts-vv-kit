      ...
      checkbox(newCheckbox){
        ...
        */
        ...
        if(newCheckbox){
          ...
          this.delActivityWorker(this.GE_WORKER.worker_id, this.getActivityId('작업가이드'))
        }
        */
      }
    },
    ...
    methods: {
      ...
      */
      ...
      agreeGuideWork() {
        ...
        /*
        let countAgree = this.GE_WORKER_ACTIVITY_LIST.filter(f=>( f.activity_id === this.getActivityId('작업가이드') && f.worker_id === this.GE_WORKER.worker_id ))
