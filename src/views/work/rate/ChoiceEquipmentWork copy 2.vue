            ...
            <base-subheading subheading="보호구 개인장비 선택" />
              ...
              <v-container>
                <v-row dense>
                  ...
                  mb="3"
                  >
                    <span> 선택된 보호구 개인장비</span>
                    <v-list>
                      <template v-for="(protectSelection, i) in protectSelections">
                        <v-list-item
                          :key="protectSelection.text"
                          :disabled="protectLoading"
                          @click="closeProtectSelected(i)"
                        >

                          <v-card>
                            <v-img 
                            :src="protectSelection.img_src"
                            max-height="150"
                            contain
                            />
                            <v-card-text
                              v-text="protectSelection.text"
                            />
                          </v-card>
              ...
              <v-container>
                <v-row dense>
                  ...
                  >
                    <span> 선택된 안전장비</span>
                    <v-list>
                      <template v-for="(safetySelection, i) in safetySelections">
                        <v-list-item
                          :key="safetySelection.text"
                          :disabled="saftyLoading"
                          @click="closeSafetySelected(i)"
                        >

                          <v-card>
                            <v-img 
                            :src="safetySelection.img_src"
                            max-height="150"
                            contain
                            />
                            <v-card-text
                              v-text="safetySelection.text"
                            />
                          </v-card>
